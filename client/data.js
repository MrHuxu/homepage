...
export const projects = {
  open: [{
    ...
    label: 'MrHuxu/homepage',
    url: 'https://github.com/MrHuxu/homepage',
...
export const websites = [{
  favicon: 'https://img.xhu.me/blog/x-billabong.png',
  url: 'blog.xhu.me',
  label: 'My blog',
  width: 15
}, {
  favicon: 'https://img.xhu.me/yrel/favicon.png',
  url: 'yrel.xhu.me',
  label: 'A script language written in Go',
  width: 28
}, {
  favicon: 'https://img.xhu.me/leetcode150/favicon.png',
